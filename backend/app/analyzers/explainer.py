...
class ExplainabilityLayer:
    @staticmethod
    def generate_summary(bug_patterns: List[BugPattern]) -> str:
        ...
        summary = f"⚠️ Found {bug_count} bug pattern(s) with {severity_label} severity. "
        summary += f"Detected patterns: {', '.join(pattern_names)}. "
        summary += "Review the detailed analysis below for explanations and fix suggestions."
